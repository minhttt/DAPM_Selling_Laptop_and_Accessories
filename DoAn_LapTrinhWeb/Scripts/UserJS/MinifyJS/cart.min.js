function reGex() {
    return regex = /(\d)(?=(\d{3})+(?!\d))/g
} function Update_quan_mouse_ev() {
    var e = $(".qty-input").data("id"); $(".btn-inc").removeClass("no-pointer-events");
    var t = $(".qty-input").val(); "" != t && (Cookie.set("product_" + e, t, 30), updateOrderPrice())
} function updateOrderPrice() {
    $(".lblCartCount").text(Cookie.countProduct());
    var e, t = $("input.qty-input"), n = 0; t.each(function (e, t) { var r = Number($(t).data("price")), i = Number($(t).val()); n += r * i });
    var r = $("#discount"), i = 0; null == r.attr("data-price") ? e = n + 3e4 : r.attr("data-price") < n ? (i = Number(r.attr("data-price")), e = n + 3e4 - i) : (i = Number(r.attr("data-price")), e = 3e4), e += "", n += "", i += "", reGex(), $(".totalPrice").text(n.replace(regex, "$1.") + "₫"), $(".totalPriceWithFee").text(e.replace(regex, "$1.") + "₫"), $("#discount").text(i.replace(regex, "$1.") + "₫")
